...
public class PaletteTests
{
    ...
    // lockstep with HorrorOccultThemePlugin.GetPalettes(); the catalog test
    // below is what enforces that they stay in sync.
    public static readonly (string Id, string Name, string Uri)[] Expected =
    {
        ("sanitarium",    "The Sanitarium",    "avares://HorrorOccultThemePlugin/Themes/Sanitarium.axaml"),
        ("eldritch-void", "The Eldritch Void", "avares://HorrorOccultThemePlugin/Themes/EldritchVoid.axaml"),
    };
    ...
    {
        var palettes = new HorrorOccultThemePlugin().GetPalettes().ToArray();
